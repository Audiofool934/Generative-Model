...
% Print out the factor examples to see their structure

% disp('Factor Examples:');
% disp('---------------');

% disp('P(X_1):');
% disp(FACTORS.INPUT(1));

% disp('P(X_2 | X_1):');
% disp(FACTORS.INPUT(2));

% disp('P(X_3 | X_2):');
% disp(FACTORS.INPUT(3));

% disp('Factor Product P(X_1, X_2):');
% disp(FACTORS.PRODUCT);

% disp('Factor Marginalization:');
% disp(FACTORS.MARGINALIZATION);

% disp('After Observing Evidence:');
% disp(FACTORS.EVIDENCE);

% disp('Joint Distribution P(X_1, X_2, X_3):');
% disp(FACTORS.JOINT);

% disp('Marginal Distribution P(X_2, X_3):');
% disp(FACTORS.MARGINAL);